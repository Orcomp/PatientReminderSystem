...
class CountriesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $states = \App\State::where('country_id', $id)->get();$cities = \App\City::where('country_id', $id)->get();$addresses = \App\Address::where('country_id', $id)->get();

        $country = Country::findOrFail($id);

        return view('admin.countries.show', compact('country', 'states', 'cities', 'addresses'));
    }
