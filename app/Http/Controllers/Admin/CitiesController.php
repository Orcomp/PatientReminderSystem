...
class CitiesController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $countries = \App\Country::get()->pluck('name', 'id')->prepend(trans('global.app_please_select'), '');$addresses = \App\Address::where('city_id', $id)->get();

        $city = City::findOrFail($id);

        return view('admin.cities.show', compact('city', 'addresses'));
    }
