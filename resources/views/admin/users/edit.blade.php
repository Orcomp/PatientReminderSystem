...
@section('javascript')
    ...
    $(function() {
        ...
        $('.panel-contacts').on('click', '.btn-address', function(){
            ...
            $('#new_contact\\[' + cfid + '\\]\\[address\\]\\[' + j + '\\]\\[country_id\\]').select2();
        ...
        $('.panel-contacts').on('click', '.btn-existing-address', function(){
            ...
            $('#contact\\[' + cfid + '\\]\\[new_address\\]\\[' + j + '\\]\\[country_id\\]').select2();
        ...
        $('.panel-contacts').on('change', '.form-country-id', function(){
            console.log('form country id changed');
            var self = this;
            var currentCountry = $(this).val();
            console.log('currentCountry init: ' + currentCountry);
            for (var i = 0; i < countryData.country.length; i++) {
                console.log('countryData.country::' + i);
        ...
        // refresh state city selects

        $('.form-country-id').trigger('change');
