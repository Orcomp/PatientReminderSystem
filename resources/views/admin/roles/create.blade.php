        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('title', trans('global.roles.fields.title'), ['class' => 'control-label required']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('permission', trans('global.roles.fields.permissions'), ['class' => 'control-label required']) !!}
