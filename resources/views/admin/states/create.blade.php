        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('name', trans('global.states.fields.name'), ['class' => 'control-label required']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('country_id', trans('global.states.fields.country'), ['class' => 'control-label required']) !!}
